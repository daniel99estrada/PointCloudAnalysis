...
file_name = "D:/PointcloudFiles/Region2_group1_densified_point_cloud_part_5.ply"
pcd = o3d.io.read_point_cloud(file_name)
axes = o3d.geometry.TriangleMesh.create_coordinate_frame()
pcd.paint_uniform_color([1.0, 0, 0])
o3d.visualization.draw_geometries([pcd, axes], window_name="Adding axes", point_show_normal=True)
...
stockpile_pcd = pcd
# Remove outliers
cl, ind = stockpile_pcd.remove_statistical_outlier(nb_neighbors=50, std_ratio=1)
stockpile_pcd = stockpile_pcd.select_by_index(ind)

# cl, ind = stockpile_pcd.remove_statistical_outlier(nb_neighbors=200, std_ratio=2)
# stockpile_pcd = stockpile_pcd.select_by_index(ind)
...
print(f"The volume of the point cloud is: {round(volume, 4)} m3")
